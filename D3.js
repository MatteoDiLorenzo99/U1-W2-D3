...
let crewMass = 0;
let iterator = 0;
while (iterator < starWarsCharacters.length) {
    crewMass += starWarsCharacters[iterator].mass;
    iterator++;
}
...
charactersNames = charactersNames.filter(name => !femaleNames.includes(name));

console.log(charactersNames.length); // Before removal
console.log(charactersNames); // After removal
...
function getRandomCharacterInfo() {
  ...
  console.log(`Eye Color: ${randomCharacter.eye_color}`);
